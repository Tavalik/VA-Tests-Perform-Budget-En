	...
	* Создаем новую организацию
		Если '$$ЭтоPerform$$' Тогда
			...
			Если '"[TheBusinessUnitType]"="ВыбратьРФ"' Тогда
				И из выпадающего списка с именем 'ТипОрганизацииУХ' я выбираю точное значение "Tax resident of the Russian Federation (Legal entity)"
				Если '"[TheBusinessUnitKind]"="ВыбратьЮЛ"' Тогда
					И из выпадающего списка с именем 'ЮридическоеФизическоеЛицо' я выбираю точное значение "Legal entity"
				Иначе
					И из выпадающего списка с именем 'ЮридическоеФизическоеЛицо' я выбираю точное значение "Individual"
			ИначеЕсли '"[TheBusinessUnitType]"="ВыбратьИн"' Тогда
				// Нет примеров
			ИначеЕсли '"[TheBusinessUnitType]"="ВыбратьЦФО"' Тогда
				И из выпадающего списка с именем 'ТипОрганизацииУХ' я выбираю точное значение "Center for financial responsibility or consolidating business unit"	
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда			
			Если '"[TheBusinessUnitType]"="ВыбратьРФ"' Тогда
				Если '"[TheBusinessUnitKind]"="ВыбратьЮЛ"' Тогда
