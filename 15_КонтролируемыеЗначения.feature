...
Сценарий: 15.01 Создание вида отчета "VA - Controlled indicators"
	...
	* Настраиваем показатели
		И Я в конструкторе отчета в ячейке 'R2C2:R3C5' я меняю свойства показателей 'КонтролируемыйПоказатель' на "True"	
		И Я в конструкторе отчета в ячейке 'R2C2' я меняю свойства показателей 'КонтролируемыйПоказатель' на "False"
		И я в конструкторе отчета в ячейке 'R3C2' я меняю свойство показателя 'КонтролируемыйПоказатель' на "False"
