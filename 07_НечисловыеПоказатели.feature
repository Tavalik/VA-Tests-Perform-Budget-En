...
Сценарий: 07.02 Создание вида отчета "VA - Non-Numbers (source)"
	...
	И я в конструкторе отчета в ячейке 'R2C2' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
	И я в конструкторе отчета в ячейке 'R2C2' я меняю свойство показателя 'ВидИтога' на "Average"
	И я в конструкторе отчета в ячейке 'R2C3' я меняю свойство показателя 'ТипЗначения' на "Date"
	И я в конструкторе отчета в ячейке 'R2C3' я меняю свойство показателя 'ВидИтога' на "Minimum"
	И я в конструкторе отчета в ячейке 'R2C4' я меняю свойство показателя 'ТипЗначения' на "Boolean"
	И я в конструкторе отчета в ячейке 'R2C4' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"		
	И я в конструкторе отчета в ячейке 'R2C4' я меняю свойство показателя 'ВидИтога' на "Cannot calculate the total by group drilldown"
	И я в конструкторе отчета в ячейке 'R2C5' я меняю свойство показателя 'ТипЗначения' на "Line"
	И я в конструкторе отчета в ячейке 'R2C5' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
...
Сценарий: 07.03 Создание экземпляра отчета - "VA - Non-Numbers (source)" 
	...
	И Я создаю экземпляр отчета для вида отчета "VA - Non-Numbers (source)" сценарий "VA - Main scenario" период '1/1/2021' '3/31/2021' периодичность "Month" организация "Mercury LLC" проект "VA - Main project" аналитики "Software sale" '' '' '' '' '' 
...
Сценарий: 07.04 Создание вида отчета "VA - Non-Numbers (recipient)"
	...
	И я в конструкторе отчета в ячейке 'R2C4:R4C4' я меняю свойства показателей 'ТипЗначения' на "Boolean"
	И я в конструкторе отчета в ячейке 'R2C5:R4C5' я меняю свойства показателей 'ТипЗначения' на "Line"
	...
	* Устанавливаем формулы расчета
		...
		* Источник
			...
			* Артикул
				...
				И из выпадающего списка с именем 'ОбъектБД' я выбираю по строке "Product range"
				Если '$$ЭтоУХ$$' Тогда
...
Сценарий: 07.05 Создание экземпляра отчета - "VA - Non-Numbers (recipient)"  
	...
	И Я создаю экземпляр отчета для вида отчета "VA - Non-Numbers (recipient)" сценарий "VA - Main scenario" период '1/1/2021' '3/31/2021' периодичность "Month" организация "Mercury LLC" проект "VA - Main project" аналитики "Software sale" '' '' '' '' '' 
...
Сценарий: 07.06 Создание вида отчета "VA - Calculation in code"
	...
	И Я в конструкторе отчета в ячейке 'R2C3:R6C3' я меняю свойства показателей 'ТипЗначения' на "Date"
	И Я в конструкторе отчета в ячейке 'R2C4:R6C4' я меняю свойства показателей 'ТипЗначения' на "Boolean"
	И Я в конструкторе отчета в ячейке 'R2C5:R6C5' я меняю свойства показателей 'ТипЗначения' на "Line"	
	...
	* Устанавливаем формулы расчета
		...
		* Расчет
			* Число
				...
				И из выпадающего списка с именем 'ВидОтчетаОтбор' я выбираю по строке "VA - Calculation in code"
				И я нажимаю кнопку выбора у поля с именем 'ПоказательОтбор'
			...
			* Булево
				...
				И я нажимаю на кнопку с именем 'ЗаписатьФормулу'
				Тогда открылось окно "Edit tree"
				И в поле с именем 'ПолеТекстовогоДокументаПроцедура' я ввожу текст "NOT [VACalculationInCode_Source_Boolean]"
				И я нажимаю на кнопку с именем 'ЗаписатьИСвернуть'
			* Строка
				Когда открылось окно "Edit tree"
				...
				И я нажимаю на кнопку с именем 'ЗаписатьФормулу'
				Тогда открылось окно "Edit tree"
				И в поле с именем 'ПолеТекстовогоДокументаПроцедура' я ввожу текст "\"!!! \" + [VACalculationInCode_Source_Line]"
				И я нажимаю на кнопку с именем 'ЗаписатьИСвернуть'
...
Сценарий: 07.08 Создание вида отчета "VA - Grouping by analytics"
	...
	* Меняем настройки показателей
		* Сумма
			И я в конструкторе отчета в ячейке 'R2C2' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Amount"
			И я в конструкторе отчета в ячейке 'R3C2' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Amount"
			И я в конструкторе отчета в ячейке 'R3C2' я меняю свойство показателя 'ВидИтога' на "Amount"
			И я в конструкторе отчета в ячейке 'R4C2' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
			И я в конструкторе отчета в ячейке 'R4C2' я меняю свойство показателя 'ВидИтога' на "Amount"
		* Максимум
			И я в конструкторе отчета в ячейке 'R2C3' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
			И я в конструкторе отчета в ячейке 'R3C3' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Amount"
			И я в конструкторе отчета в ячейке 'R3C3' я меняю свойство показателя 'ВидИтога' на "Maximum"
			И я в конструкторе отчета в ячейке 'R4C3' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
			И я в конструкторе отчета в ячейке 'R4C3' я меняю свойство показателя 'ВидИтога' на "Maximum"
		* Минимум
			И я в конструкторе отчета в ячейке 'R2C4' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
			И я в конструкторе отчета в ячейке 'R3C4' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Amount"
			И я в конструкторе отчета в ячейке 'R3C4' я меняю свойство показателя 'ВидИтога' на "Minimum"
			И я в конструкторе отчета в ячейке 'R4C4' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
			И я в конструкторе отчета в ячейке 'R3C4' я меняю свойство показателя 'ВидИтога' на "Minimum"
		* Среднее
			И я в конструкторе отчета в ячейке 'R3C5' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Amount"
			И я в конструкторе отчета в ячейке 'R3C5' я меняю свойство показателя 'ВидИтога' на "Average"
			И я в конструкторе отчета в ячейке 'R4C5' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
			И я в конструкторе отчета в ячейке 'R4C5' я меняю свойство показателя 'ВидИтога' на "Average"
		* БезИтога
			И я в конструкторе отчета в ячейке 'R2C6' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
			И я в конструкторе отчета в ячейке 'R3C6' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Amount"
			И я в конструкторе отчета в ячейке 'R3C6' я меняю свойство показателя 'ВидИтога' на "Cannot calculate the total by group drilldown"
			И я в конструкторе отчета в ячейке 'R4C6' я меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
			И я в конструкторе отчета в ячейке 'R4C6' я меняю свойство показателя 'ВидИтога' на "Cannot calculate the total by group drilldown"
...
Сценарий: 07.09 Создание экземпляра отчета - "VA - Grouping by analytics"
	...
	И Я создаю экземпляр отчета для вида отчета "VA - Grouping by analytics" сценарий "VA - Main scenario" период '1/1/2021' '3/31/2021' периодичность "Month" организация "Mercury LLC" проект "VA - Main project" аналитики "Software sale" '' '' '' '' '' 
	...
	* Проверяем движения	
		Тогда Открылся экземпляр отчета для вида отчета "VA - Grouping by analytics" валюта 'RUB' организация "Mercury LLC" сценарий "VA - Main scenario" периодичность "Month" проект "VA - Main project" аналитики "Software sale" '' '' '' '' '' 
		И я нажимаю на кнопку с именем 'ФормаОткрытьДвиженияДокументаПлоскаяТаблица'
		Тогда открылось окно "Flat table of indicator values"
		И я жду когда в табличном документе 'ОтчетТабличныйДокумент' заполнится ячейка 'R2C1' в течение 30 секунд
