...
Сценарий: 09.02 Создание вида отчета "VA - Currency indicators (source)"
	...
	И Я в конструкторе отчета в ячейке 'R5C2' меняю свойство показателя 'ТипЗначения' на "Date"
	И Я в конструкторе отчета в ячейке 'R5C2' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
	И Я в конструкторе отчета в ячейке 'R6C2' меняю свойство показателя 'НеФинансовый' на "True"
	И Я в конструкторе отчета в ячейке 'R6C2' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
	И Я в конструкторе отчета в ячейке 'R7C2' меняю свойство показателя 'НеФинансовый' на "True"
	И Я в конструкторе отчета в ячейке 'R7C2' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Total by period is not calculated"
	...
	И Я в конструкторе отчета в ячейке 'R2C2' проверяю свойство показателя 'ПересчитыватьВалютнуюСумму' на "False"
	И Я в конструкторе отчета в ячейке 'R2C2:R4C2' меняю свойства показателей 'ПересчитыватьВалютнуюСумму' на "True"
	И Я в конструкторе отчета в ячейке 'R2C2' проверяю свойство показателя 'ПересчитыватьВалютнуюСумму' на "True"
...
Сценарий: 09.04 Создание экземпляра отчета - "VA - Currency indicators (source)" 
	...
	* Вводим значения с аналитиками, проверяем пересчет в валюту
		...
		И я заполняю таблицу 'РаскрытиеПоказателей' данными
			| "Counterparties"     | "Currencies" | 'Период_1_Значение1' | 'Период_1_ЗначениеВалюта1' |
		...
		Тогда таблица 'РаскрытиеПоказателей' стала равной:
			| "Counterparties"     | "Currencies" | 'Период_1_Значение1' | 'Период_1_ЗначениеВалюта1' | 'Период_2_Значение1' | 'Период_2_ЗначениеВалюта1' | 'Период_3_Значение1' | 'Период_3_ЗначениеВалюта1' |
